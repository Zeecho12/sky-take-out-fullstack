...
<style scoped>
.order-confirm { min-height: 100vh; background: var(--c-bg); }
...
.addr-card:hover { border-color: var(--c-border-2); box-shadow: var(--shadow-md); }
...
.addr-empty { color: var(--c-muted); font-size: 15px; }
.addr-arrow { position: absolute; right: 14px; top: 50%; transform: translateY(-50%); color: var(--c-muted); }
...
.goods-num { color: var(--c-muted); margin: 0 12px; }
